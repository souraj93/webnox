...
!function(t) {
    ...
    e.prototype.transition = function() {
        ...
        if (!o)
            return void p("aria-valuetransitiongoal not set");
        var l = Math.round(100 * (o - h) / (d - h));
        if ("center" === r.display_text && !s && !i) {
            this.$back_text = s = t("<span>").addClass("progressbar-back-text").prependTo(a),
        ...
        setTimeout(function() {
            ...
            var v = setInterval(function() {
                ...
                c(),
                clearInterval(v)),
                "none" !== r.display_text && (_ = r.use_percentage ? r.percent_format(t) : r.amount_format(e, d),
                "fill" === r.display_text ? n.text(_) : "center" === r.display_text && (s.text(_),
                i.text(_))),
    ...
    t.fn.progressbar = function(n) {
        return this.each(function() {
            var a = t(this)
              ...
              , i = "object" == typeof n && n;
            s || a.data("bs.progressbar", s = new e(this,i)),
            s.transition()
        })
    }
    ,
